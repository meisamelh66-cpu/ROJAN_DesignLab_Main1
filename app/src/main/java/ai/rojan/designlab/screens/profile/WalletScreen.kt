...
/**
 * Journey 2, Screen 4: Wallet.
 *
 * Production Data Integrity Phase 1: gated. No wallet/balance endpoint
 * exists anywhere in `data/remote/dto/` or `domain/repository/` — this
 * was entirely demo/in-memory state
 * ([ai.rojan.designlab.data.demo.DemoWalletRepository] via
 * [CustomerEcosystemViewModel]). Entry point stays reachable from Profile;
 * content becomes a Coming Soon state until a real wallet capability
