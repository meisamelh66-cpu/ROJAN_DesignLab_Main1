...
/**
 * A real backend customer account who has booked with a specific salon
 * before. [email] is nullable — a phone-only OTP account (see
 * [ai.rojan.designlab.data.remote.dto.UserResponseDto.email]'s own doc
 * comment) may genuinely have none on file; never fabricated here.
 */
